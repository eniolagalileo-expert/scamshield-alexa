...
import { CALM, scamRecovery } from "./recovery.js";
...
const T = {
  en: {
    ...
    help: "You can say: is this a scam, then read the message. Or say: someone's on the phone. Or: what scams are going around. Or, if it already happened: I think I got scammed. What would you like?",
  ...
  es: {
    ...
    help: "Puede decir: es esto una estafa, y leer el mensaje. O diga: alguien me está llamando. Y si ya pasó, diga: creo que me estafaron. ¿Qué le gustaría hacer?",
...
function recovery(ctx, what) {
  ...
  const speech = `${CALM[ctx.lang]} ${plan.steps.slice(0, 3).join(" ")}${more} ${t.offerReport}`;
