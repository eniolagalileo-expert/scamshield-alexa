...
**Website and phone app:** no accounts, cookies or analytics. A pasted or shared message is checked and forgotten. "Read it to me" uses the browser's built-in voice, and "Warn my family" is written on the device for the person to share. The offline cache holds only the app's own pages, never messages. The full policy for users is at https://scamshield-alexa.onrender.com/privacy.html.
